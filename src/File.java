public class File {
    ...
    public void push( int element){
        ...
        if(((tail == MAX_SIZE-1) && (head==0)) || (tail == head-1)){ 
           ...
           if( head==-1){
            head=0 ; tail=0; circularArray[head]= element; length++; return;
           }
    ...
    public int pop() {
        ...
        if(tail==head) {
            ...
            head=-1; tail=-1; length--; return value1; }
            // cas normal
...
if(length==0){ System.out.println("La liste est vide");  return;
}
...
return elemExist;
    ...
    public void remove(int value) {
        ...
        for(int i = 0; i <  length; i++){
            ...
            if(tempPop == value){  numTimeElementFound++;}
